...
import { parseVoteMatrixCSV, parseVotesLogCSV, parseCommentsCSV } from './csv.ts';
import { zSig90, propTest, addComparativeStats, selectRepComments } from './repness.ts';
  ...
  return (
    <div className="App">
      ...
      <div className="side-by-side-container">
        <PCAProjection pcaProjection={pcaProjection} groups={groups} selectedGroup={selectedGroup} />
        <GroupAnalysis
          groups={groups}
